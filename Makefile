...
baseline-human-comparison:
	@$(VENV_PYTHON) analysis/baseline_human_comparison.py
...
paper-hardening: figure-export multimodel-table multimodel-coverage-curve corpus-diversity non-llm-baseline baseline-human-comparison rs-weight-sensitivity sigma-replay-intervals leakage-audit contamination-audit statistical-hardening hardening-registry number-consistency float-reference overleaf-analysis-sources regeneration-drift-check
