...
Full scale-up corpus & \texttt{make scaleup-full} & Ignored full JSONL corpus, public sample, manifest, and validation summary & Completed locally; release upload pending \\
Exact-size multi-model replication & \texttt{make multimodel-exact-size} & Per-model ignored corpora plus tracked aggregate table and audit note & Completed locally \\
